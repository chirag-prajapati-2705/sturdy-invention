                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ URL::to('admin/user/create') }}">Add User</a>
                            </li>
                            <li>
                                <a href="{{ URL::to('admin/user/show') }}">List User</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ URL::to('admin/product/create') }}">Add Product</a>
                            </li>
                            <li>
                                <a href="{{ URL::to('admin/product/show') }}">List</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
